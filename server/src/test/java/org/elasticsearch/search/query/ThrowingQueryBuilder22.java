...
public class ThrowingQueryBuilder22 extends AbstractQueryBuilder<ThrowingQueryBuilder22> {
    ...
    /**
     * Creates a {@link ThrowingQueryBuilder22} with the provided <code>randomUID</code>.
     *
     ...
     */
    public ThrowingQueryBuilder22(long randomUID, RuntimeException failure, int shardId) {
        super();
     ...
     */
    public ThrowingQueryBuilder22(long randomUID, RuntimeException failure, String index) {
        super();
        this.randomUID = randomUID;
        this.failure = failure;
    ...
    public ThrowingQueryBuilder22(StreamInput in) throws IOException {
        super(in);
    ...
    @Override
    protected boolean doEquals(ThrowingQueryBuilder22 other) {
        return false;
    }
