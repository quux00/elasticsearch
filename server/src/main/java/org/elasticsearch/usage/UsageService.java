...
import org.elasticsearch.action.admin.cluster.stats.CCSUsageHolder;
...
public class UsageService {
    ...
    private final CCSUsageHolder ccsUsageHolder;

    public UsageService() {
        this.handlers = new HashMap<>();
        this.searchUsageHolder = new SearchUsageHolder();
        this.ccsUsageHolder = new CCSUsageHolder();
    }
    ...
    public CCSUsageHolder getCcsUsageHolder() {
