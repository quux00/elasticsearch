...
public class SearchResponse extends ActionResponse implements ChunkedToXContentObject {
    ...
    public static class Clusters implements ToXContentFragment, Writeable {
        ...
        public Clusters(StreamInput in) throws IOException {
            ...
            if (in.getTransportVersion().onOrAfter(TransportVersion.V_8_500_063)) {
        ...
        public void writeTo(StreamOutput out) throws IOException {
            ...
            if (out.getTransportVersion().onOrAfter(TransportVersion.V_8_500_063)) {
        ...
        /**
         * @return true if any underlying Cluster objects have RUNNING, PARTIAL, SKIPPED, FAILED or CANCELLED status.
         */
        public boolean hasPartialResults() {
            return clusterInfo.values().stream().anyMatch(ref -> ref.get().getStatus() != Cluster.Status.SUCCESSFUL);
        }
        ...
        public Set<String> getClusterAliases() {
            return Collections.unmodifiableSet(clusterInfo.keySet());
        }
    }
