...
// this used to be called CrossClusterSearchIT, but it mostly focuses on
// non-core search actions, so it was renamed and the new CrossClusterSearchIT
// focuses entirely on synchronous CrossClusterSearch testing.
public class CrossClusterActionsIT extends AbstractMultiClustersTestCase {
