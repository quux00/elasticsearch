...
public class ComputeListenerTests extends ESTestCase {
    ...
    public void testEmpty() {
        ...
        try (ComputeListener ignored = new ComputeListener(transportService, newTask(), null, results)) {
    ...
    public void testCollectComputeResults() {
        ...
        try (ComputeListener computeListener = new ComputeListener(transportService, newTask(), executionInfo, future)) {
    ...
    public void testCancelOnFailure() throws Exception {
        ...
        EsqlExecutionInfo executionInfo = new EsqlExecutionInfo();
        try (ComputeListener computeListener = new ComputeListener(transportService, rootTask, executionInfo, rootListener)) {
