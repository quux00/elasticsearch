...
public class IndexResolver {
    ...
    public IndexResolution mergedMappings(String indexPattern, FieldCapabilitiesResponse fieldCapsResponse) {
        ...
        // MP TODO: we can reconstruct the indexPattern to only match the indices that came back from field-caps here
        // MP TODO    and not pollute EsIndex with bad info
