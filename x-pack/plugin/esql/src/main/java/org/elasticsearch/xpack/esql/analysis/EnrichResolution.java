...
public final class EnrichResolution {
    ...
    // skip_unavailable=true remote clusters that are unavailable or had errors when finding/resolving the enrich policy
     ...
     *         Key of may is cluster alias, value is the Exception showing the particular error encountered.
     */
    public Map<String, Exception> getUnusableRemotes() {
